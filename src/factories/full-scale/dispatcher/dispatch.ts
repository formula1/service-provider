...
// } from "./models";
//
// import { IContainer, IDispatcher, IKeySetStore, ILambda } from "../../types";
//
...
//   return serviceprovider.resolveRequirements("dispatcher-dispatch-lambda").then(function(services){
//     const [ KeyToDispatchStrategy ] = <[
//       IKeySetStore<string, IAbstractDispatchStrategy>
//     ]> services;
//     return KeyToDispatchStrategy.getKey(input.key);
//   }).then(function(dispatchStrategies){
